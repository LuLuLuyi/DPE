...
def replace_with_dpe(scale_factors_arg, local_window_size_arg, dim_groups_range_arg, select_topk_dim_arg=False, topk_dim_arg=None, selected_dim_path_arg=None):
    ...
    transformers.models.llama.modeling_llama.LlamaAttention.forward = dpe_flash_forward
    transformers.models.llama.modeling_llama.LlamaFlashAttention2.forward = dpe_flash_forward
