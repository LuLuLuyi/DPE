...
def replace_with_dpe(scale_factors_arg, local_window_size_arg, dim_groups_range_arg, select_topk_dim_arg=False, topk_dim_arg=None, selected_dim_path_arg=None):
    ...
    transformers.models.qwen2.modeling_qwen2.Qwen2Attention.forward = dpe_flash_forward
    transformers.models.qwen2.modeling_qwen2.Qwen2FlashAttention2.forward = dpe_flash_forward
